...
const setupTextHover = (container, type) => {
    // If the container isn't available return a no-op cleanup so callers
    // can safely invoke it during effect cleanup.
    if(!container) return () => {};
...
const Welcome = () => {
    ...
    return (
        <section id="welcome">
            <p ref={subtitleRef}>
                {renderText("Hey, I'm RADWANE! Welcome to my", "text-3xl font-georama", 100)}
            </p>
